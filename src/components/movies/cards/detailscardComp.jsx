...
const DetailsCardComp = props => {
  const {selectedMovie, setSelectedMovie, setRefresh} = props.detailsCardObj;
  ...
  return (
    <>
      ...
      <div className="select-none absolute mx-3 md:mx-[10%] lg:mx-[20%] my-5 md:my-10 md:w-[80vh] lg:w-[100vh] md:h-[90vh] w-[95%] flex flex-col gap-2 z-10 bg-gray-950/90 rounded text-white border-2 border-gray-400/30">
        ...
        <div className="mx-4 justify-start flex flex-row gap-4 mb-5 pl-4 pr-4">
        ...
        <div className="mx-auto">
          <iframe
            ...
            title="Youtube video"
            className="lg:w-[600px] lg:h-[320px] w-[360px] h-[240px] mb-2"
          />
        </div>
